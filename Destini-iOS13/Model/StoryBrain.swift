...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String){
        ...
        if userChoice == stories[storyCount].choice1 {
            storyCount = stories[storyCount].choice1Destination
        }
        if userChoice == stories[storyCount].choice2 {
            storyCount = stories[storyCount].choice2Destination
        }
